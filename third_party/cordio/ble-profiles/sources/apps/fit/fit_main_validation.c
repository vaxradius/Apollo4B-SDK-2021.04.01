...
{
  {1600*10,     0,     0},                  /*! Advertising durations in ms */
...
static void CooperShtdwnTimerStart(uint16_t period)
{

  /* Configure and start timer to send the next measurement */
  shutdwnTimer.msg.event = COOPER_SHTDWN_TIMER_IND;
  shutdwnTimer.handlerId = fitHandlerId;

  WsfTimerStartSec(&shutdwnTimer, period);
}
